...
from sklearn_morpho.binary import MorphologicalClassifier as MC
from sklearn_morpho.binary.sample_data import SampleData
...
def _get_prop_well_classified(sample_data: SampleData, classifier: MC) -> float:
